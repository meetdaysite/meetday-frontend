...
function OptionCard({ label, image, selected, onSelect }: OptionCardProps) {
	return (
		<button
			...
			onClick={onSelect}
			className={clsx(
				"relative flex flex-col items-center gap-3 rounded-action border-2 bg-surface-canvas overflow-hidden",
		...
		>
			...
			{/* Image */}
			<div className="relative w-full aspect-square overflow-hidden rounded-action">
