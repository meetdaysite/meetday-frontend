...
export function EventSummaryRow({ event }: { event: PublicEventDetails }) {
	...
	return (
		<div className="rounded-card bg-surface-card border border-border-subtle overflow-hidden grid grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-border-subtle">
			{/* Col 1 — About */}
