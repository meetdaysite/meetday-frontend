...
export default function SpaceCommunityRequestsPage() {
	return (
		<Suspense fallback={null}>
			<div className="flex flex-col flex-1 min-h-0 bg-white">
				...
				<div className="flex-1 min-h-0 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 max-w-6xl w-full mx-auto flex flex-col gap-4">
					<div>
						<h1 className="text-2xl sm:text-3xl font-heading font-black text-black">Sent Requests</h1>
						<p className="text-xs sm:text-sm font-semibold text-black/50 mt-1">
							Chat, lock the deal, and submit your report with communities you've partnered with.
						</p>
					</div>
					<SpaceHostChatDashboard
						role="SPACE"
						emptyLabel="No communities yet — browse Communities to send a request."
					/>
				</div>
			</div>
		</Suspense>
