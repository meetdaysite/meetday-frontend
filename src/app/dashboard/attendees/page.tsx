...
function AttendeeCard({ attendee }: { attendee: Attendee }) {
	...
	return (
		<div className="bg-surface-card border border-border-subtle rounded-card px-4 py-4 flex items-center gap-3 hover:border-border-default transition-colors">
			{/* Avatar */}
