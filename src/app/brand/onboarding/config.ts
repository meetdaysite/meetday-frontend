...
export const STEP_PANEL_CONFIGS: StepPanelConfig[] = [
	// Step 1 — Tell us about you
	{
		...
		description: "Brands like you build more than events. You build trust, community, and moment that matter",
	...
	// Step 2 — Set up your brand profile
	{
		...
		description: "A little about you goes a long way. Help people connect with the human behind the brand.",
	...
	// Step 3 — Links & legal details
	{
		...
		cards: [
			...
			},
			{
				...
				body: "Complete your details to unlock more branding features.",
				position: { bottom: "8%", left: "18%" },
			},
		],
	},
	...
	// Step 4 — Experience & Focus
	{
		...
		description: "Every event you've branded has shaped who you are. Tell us about your journey so we can match you with the right tools and community.",
		personImage: "/onboarding/person-2.png",
		cards: [
			{
				icon: "/icons/onboarding/stars.svg",
			...
			},
			{
				...
				body: "Get matched with brands at your level.",
				position: { top: "52%", left: "4%" },
			},
			{
				icon: "/icons/onboarding/chart-2.svg",
	...
	// Step 8 — You're ready to brand
	{
		headingPlain: "Your stage",
		headingHighlight: "is ready",
		description: "You've got everything you need to brand amazing events, build your community, and grow your impact",
