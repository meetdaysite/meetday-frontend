		...
		return (
			<div className="flex flex-col min-h-screen">
				...
				<div className="flex flex-col items-center justify-center flex-1 gap-4">
					...
					<Link href="/brand/dashboard/events" className="text-label-sm text-text-brand hover:underline">
						← Back to My Events
					</Link>
				</div>
			</div>
									...
									onEdit={() =>
										router.push(
											event.status === "PUBLISHED"
												? `/brand/dashboard/events/${event.id}/revise`
												: `/brand/dashboard/events/${event.id}/edit`,
										)
									}
