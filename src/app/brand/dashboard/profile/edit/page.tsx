...
import { updateBrandProfile, getBrandProfile, getCategories, getUploadUrl } from "@/lib/api"
...
export default function EditProfilePage() {
	...
	async function handleSave() {
		...
		try {
			...
			setTimeout(() => router.push("/brand/dashboard/profile"), 1000)
		} catch (err) {
			showToast(getApiErrorMessage(err), "error")
		} finally {
			setSaving(false)
			...
			<div className="flex-1 px-4 sm:px-6 lg:px-8 py-6 lg:py-8 bg-surface-page">
				...
				<div className="flex items-center justify-between mb-6">
					<div>
						...
						<p className="text-body-sm text-text-secondary mt-0.5">Update your brand identity and details</p>
					</div>
					<div className="flex items-center gap-3">
						<Button variant="secondary" size="md" radius="pill" onClick={() => router.push("/brand/dashboard/profile")} disabled={saving}>
							Cancel
						</Button>
				...
				<div className="max-w-2xl flex flex-col gap-4">
					...
					<div className="flex justify-end gap-3 pt-2 pb-4">
						<Button variant="secondary" size="lg" radius="pill" onClick={() => router.push("/brand/dashboard/profile")} disabled={saving}>
							Cancel
						</Button>
