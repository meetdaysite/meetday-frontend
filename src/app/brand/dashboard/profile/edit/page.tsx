...
export default function EditProfilePage() {
	...
	return (
		<div className="flex flex-col min-h-full bg-white">
			...
			<div className="flex-1 min-h-0 w-full overflow-hidden relative md:grid md:grid-cols-[65%_35%]">
				{/* Left Column: Profile details */}
				<div className="px-4 lg:px-6 py-8 flex-1 flex flex-col gap-8 overflow-y-auto h-full w-full max-w-none">
					{/* Header */}
					<div>
					...
					<div className="flex flex-col mt-4">
						...
						<div className="flex items-center justify-between py-4 border-b border-black/10 hover:bg-black/[0.01]">
							...
							<div className="flex items-center gap-3">
								<button 
									disabled
									className="bg-[#EE2C2C] text-white text-[9px] font-black px-2.5 py-1.5 rounded-lg uppercase tracking-wider shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] opacity-50 select-none cursor-not-allowed"
								>
									EDITING...
								</button>
				...
				{/* Right Column: Edit Profile drawer (Always Open on this page) */}
				<div className={clsx(
					"bg-white h-full flex flex-col z-50 transition-all duration-300",
					...
					<EditBrandProfilePanel
						onClose={() => router.push("/brand/dashboard/profile")}
						onSuccess={() => router.push("/brand/dashboard/profile")}
					/>
				</div>
			</div>
		</div>
