						...
						<div className="py-12 flex flex-col items-center text-center">
							...
							{events.length === 0 ? (
								<>
									...
									<Link href="/brand/dashboard/create" onClick={onClose} className="text-label-sm text-text-brand font-medium hover:underline flex items-center gap-1">
										Create a new one
				...
				{!loading && !fetchError && events.length > 0 && (
					<div className="px-6 py-2 border-t border-border-subtle shrink-0">
						<p className="text-caption text-text-muted">
							...
							<Link href="/brand/dashboard/create" onClick={onClose} className="text-text-brand font-medium hover:underline inline-flex items-center gap-0.5">
								Create a new one
