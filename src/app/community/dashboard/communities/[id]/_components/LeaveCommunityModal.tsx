...
export function LeaveCommunityModal({ communityName, open, onClose, onConfirm }: LeaveCommunityModalProps) {
				...
				<div className="flex flex-col items-center p-6 gap-4">
					...
					<div className="text-center">
						...
						<p className="text-label-sm text-text-secondary font-normal mt-1.5 leading-relaxed">
							You&apos;ll lose access to the members-only feed, announcements, audience insights, and
							won&apos;t be able to publish experiences to this community. You can request to join again anytime.
						</p>
					</div>
