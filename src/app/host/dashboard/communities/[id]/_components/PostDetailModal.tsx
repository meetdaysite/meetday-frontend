...
export function PostDetailModal({ postId, communityId, onClose }: PostDetailModalProps) {
								...
								<div className="border-t border-border-default px-5 pt-4 pb-5 flex flex-col gap-3">
									...
									<div className="flex items-center gap-2">
										{hostProfile?.avatarUrl ? (
											...
											<div
												className={`size-8 rounded-full ${avatarColor(hostProfile?.displayName ?? "?").bg} border ${avatarColor(hostProfile?.displayName ?? "?").border} flex items-center justify-center shrink-0`}
											>
												<span
