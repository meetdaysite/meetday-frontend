		...
		<div className="flex flex-col min-h-screen bg-surface-canvas">
			...
			<div className="flex-1 flex flex-col items-center justify-center gap-6 px-6 py-10">
				...
				<div className="text-center">
					<p className="text-heading-sm text-text-primary mb-2">Invalid ticket</p>
					<p className="text-label-md text-text-secondary leading-snug">
						{message ??
							"This QR code could not be verified. Ask the attendee to show their original confirmation email."}
					</p>
				</div>
...
function XIcon() {
	return (
		<svg width="36" height="36" viewBox="0 0 24 24" fill="none" className="text-text-danger" aria-hidden>
