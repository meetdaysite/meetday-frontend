	...
	return (
		<div className="flex flex-col min-h-screen bg-white">
			...
			<div className="flex-1 flex flex-col gap-5 px-4 py-5 overflow-y-auto">
				...
				{/* Tabs */}
				<div className="flex bg-neutral-100 rounded-action p-1">
				...
				<div className="flex flex-col gap-2">
					<div className="flex items-center gap-2 px-3 py-3 border border-neutral-200 rounded-action bg-neutral-50">
						<SearchIcon />
						<input
							type="text"
							value={query}
						...
						{results.length === 0 ? (
							...
							<div className="flex flex-col gap-2">
								{results.map((booking) => {
									...
									return (
										<div key={booking.bookingId} className="border border-neutral-200 rounded-action shadow-md overflow-hidden">
