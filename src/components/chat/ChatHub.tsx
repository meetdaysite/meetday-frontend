		...
		spaceThreads.forEach((t) => {
			...
			if (role === "SPACE") {
				...
				result[catKey].push({
					...
					title: t.counterpartName || "Space Booking",
					subtitle: t.counterpartName,
					lastMessagePreview: t.lastMessagePreview,
					lastMessageAt: t.lastMessageAt,
					createdAt: t.createdAt,
		...
		spaceHostThreads.forEach((t) => {
			...
			if (role === "SPACE") {
				result.communities.push({
					...
					title: t.counterpartName || "Space Partnership",
					subtitle: t.counterpartName,
					lastMessagePreview: t.lastMessagePreview,
					lastMessageAt: t.lastMessageAt,
					createdAt: t.createdAt,
		...
		if (role === "COMMUNITY") {
			...
			spaceThreads.forEach((t) => {
				if (t.chatStatus === "REQUESTED") {
					list.push({
						...
						counterpartType: "SPACE",
						title: t.counterpartName || "Space Booking",
						description: "You sent a booking inquiry to this space.",
						createdAt: t.createdAt,
						lastMessagePreview: t.lastMessagePreview,
						isIncoming: false,
						rawItem: t,
			...
			spaceHostThreads.forEach((t) => {
				if (t.chatStatus === "REQUESTED") {
					list.push({
						...
						counterpartType: "SPACE",
						title: t.counterpartName || "Space Partnership",
						description: "This space partner wants to host your community events.",
						createdAt: t.createdAt,
						lastMessagePreview: t.lastMessagePreview,
						isIncoming: true,
						rawItem: t,
			...
			sponsorshipRequested.forEach((t) => {
				list.push({
					...
					counterpartAvatarUrl: t.counterpartAvatarUrl,
					counterpartType: "BRAND",
					title: t.proposalName || "Space Sponsorship",
					description: "This brand is interested in your space sponsorship proposal.",
					createdAt: t.createdAt,
					lastMessagePreview: t.lastMessagePreview,
					isIncoming: true,
					rawItem: t,
			...
			spaceThreads.forEach((t) => {
				if (t.chatStatus === "REQUESTED") {
					...
					list.push({
						...
						counterpartAvatarUrl: t.counterpartAvatarUrl,
						counterpartType: t.requesterType,
						title: t.counterpartName || "Space Inquiry",
						description: `${t.counterpartName} requested to book or partner with your space.`,
						createdAt: t.createdAt,
						lastMessagePreview: t.lastMessagePreview,
						isIncoming: true,
						rawItem: t,
			...
			spaceHostThreads.forEach((t) => {
				if (t.chatStatus === "REQUESTED") {
					list.push({
						...
						counterpartAvatarUrl: t.counterpartAvatarUrl,
						counterpartType: "COMMUNITY",
						title: t.counterpartName || "Space Outreach",
			...
			spaceThreads.forEach((t) => {
				if (t.chatStatus === "REQUESTED") {
					list.push({
						...
						counterpartType: "SPACE",
						title: t.counterpartName || "Space Inquiry",
						description: "You sent an inquiry to this space partner.",
						createdAt: t.createdAt,
						lastMessagePreview: t.lastMessagePreview,
						isIncoming: false,
						rawItem: t,
		...
		if (role === "COMMUNITY") {
			...
			return [
				...
				}, */
				{
					key: "spaces",
					label: "Spaces",
					description: "Collaborate with community spaces & venues for events.",
			...
			return [
				{
					key: "sponsorships",
					label: "Sponsorships",
					description: "Talk to brands interested in space sponsorship proposals.",
					badgeCount: spUnread,
					activeCount: activeThreadsByCategory.sponsorships.length,
					pendingRequestsCount: spPending,
				},
				...
				},
				{
					key: "brands",
					label: "Brands",
					description: "Manage space bookings and inquiries from brands.",
					badgeCount: brUnread,
			...
			return [
				...
				}, */
				{
					key: "spaces",
					label: "Spaces",
					description: "Explore and book verified venues & community spaces.",
					badgeCount: spcUnread,
					activeCount: activeThreadsByCategory.spaces.length,
					pendingRequestsCount: spcPending,
				},
