...
export function AuthShell({ children, phoneImage, pointsImage }: AuthShellProps) {
	return (
		<div className="flex flex-1">
			{/* ── Left — form panel ── */}
			<div className="flex flex-1 items-start lg:items-center justify-center px-4 py-8 lg:pl-8 lg:pr-3 xl:pl-12 xl:pr-4">
				<div
					className={[
						"w-full bg-surface-card rounded-modal shadow-modal my-auto",
						"px-5 py-6 mb-8",
						"lg:px-7 lg:py-7 lg:max-w-100 lg:mb-0",
