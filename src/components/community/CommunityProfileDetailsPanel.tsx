			...
			{currentExp && (
				...
				>
					<div 
						...
						className="relative max-w-[96vw] xl:max-w-7xl 2xl:max-w-[1440px] w-full bg-white border-[3px] border-black rounded-[32px] p-6 sm:p-8 md:p-9 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] flex flex-col gap-5 max-h-[95vh] overflow-hidden animate-in zoom-in-95 duration-150 cursor-default"
					>
						{/* Top Header with title and controls */}
						<div className="flex items-center justify-between gap-4 w-full shrink-0 border-b-2 border-black/15 pb-4">
							<div className="flex flex-col gap-1 min-w-0">
								<span className="text-xs sm:text-sm font-black text-[#EE2C2C] uppercase tracking-wider">
									Experience #{currentExp.eventNumber}
								</span>
								<h3 className="text-xl sm:text-2xl md:text-3xl font-heading font-black text-black truncate">
